...
const DesignSystemDemo: React.FC = () => {
  const { theme, effectiveTheme, setTheme, isDark, isLight, isSystem } = useTheme();
        ...
        <div className="container mx-auto p-8 space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Button variants in different sizes and states
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Card variants with different content layouts
              </CardDescription>
            </CardHeader>
            <CardContent>
