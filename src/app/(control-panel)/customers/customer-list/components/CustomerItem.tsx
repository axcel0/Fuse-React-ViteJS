import { Checkbox, Typography, Button, Avatar } from "@mui/material";
...
const CustomerItem: React.FC<CustomerItemProps> = ({
  ...
  return (
    <div className="py-2 border-b-2 border-[#f8fafb] pl-2 pr-6">
      <div className="flex items-center justify-between">
        <div className="flex gap-2 items-center w-[22%] cursor-pointer">
          <Checkbox />
          <Avatar
            alt="Remy Sharp"
          ...
          />
          <Typography onClick={() => handleNavDetail()}>{fullName}</Typography>
        </div>
        <div className="w-[18%] text-green-600">
          <div className="w-[45%] flex items-center justify-center py-[2px] gap-1 border-1 border-green-600 rounded-md">
            <CircleRoundedIcon className="block text-[8px]" />
            <Typography className="block" fontSize={11}>
              {emailSubs}
            </Typography>
          </div>
        </div>
        ...
        <div className="w-[15%]">
          <Typography>${amountSpent}.00</Typography>
        </div>
