					...
					<Reference>
						{({ ref }) => (
							<div ref={ref}>
								<Root
									component={component}
									className={clsx('fuse-list-item', opened && 'open', isUrlInChildren(item, pathname) && 'active')}
								...
								>
									...
									<IconButton disableRipple className="h-3 w-3 p-0 ltr:ml-1 rtl:mr-1" color="inherit">
										<FuseSvgIcon size={12} className="arrow-icon">
